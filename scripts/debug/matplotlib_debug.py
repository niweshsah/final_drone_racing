...
class TrajectoryGenerator:
    ...
    def __init__(self, gates_pos, gates_rpy, obstacles_pos, start_pos):  # noqa: ANN001, D107
    ...
    def generate_spline(self):  # noqa: ANN201, D102
        # 1. Approach Points
    ...
    def _generate_gate_approach_points(self, initial_pos, gate_pos, gate_norm, approach_dist=0.5, num_pts=5):  # noqa: ANN001, ANN202
    ...
    def _determine_detour_direction(self, v_proj, v_proj_norm, y_axis, z_axis):  # noqa: ANN001, ANN202
        if v_proj_norm < 1e-6:
            return y_axis
        ...
        if -90 <= angle_deg < 45: return y_axis  # noqa: E701
        elif 45 <= angle_deg < 135: return z_axis  # noqa: E701
        else: return -y_axis  # noqa: E701

    def _add_detour_logic(self, path_points, g_pos, g_norm, g_y, g_z, num_pts=5, angle_deg=120.0, rad=0.65):  # noqa: ANN001, ANN202
        ...
        for i in range(num_gates - 1):
            ...
            if first_idx_next >= len(pts_list): break  # noqa: E701
            ...
            if norm < 1e-6: continue  # noqa: E701
    ...
    def _process_single_obstacle(self, obs_center, sampled_points, sampled_times, clearance):  # noqa: ANN001, ANN202
        ...
        for i, point in enumerate(sampled_points):
            ...
            if dist_xy < clearance:
                ...
                if norm_v > 0: avoid_vec /= norm_v  # noqa: E701
    ...
    def _insert_obstacle_avoidance_points(self, path_points, obstacle_centers, clearance):  # noqa: ANN001, ANN202
    ...
    def _compute_trajectory_spline(self, total_time, path_points, custom_time_knots=None):  # noqa: ANN001, ANN202
...
def load_from_toml(filepath):  # noqa: ANN001, ANN201
...
def plot_gate_3d(ax, center, rpy, size=0.5):  # noqa: ANN001
...
def plot_obstacle_3d(ax, center, radius=0.15, height=1.5):  # noqa: ANN001
